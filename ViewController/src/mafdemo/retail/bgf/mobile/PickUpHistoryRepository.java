...
public class PickUpHistoryRepository {
    ...
    public PickUpOrder[] getPickUpOrders(boolean includeItems) {
        ...
        final String sql = "SELECT O.ID, O.STATUS, O.CUSTOMER_ID, O.STORE_ID, S.NAME STORE_NAME, " +
    ...
    public void insertPickUpOrder(PickUpOrder order) {
        ...
        PreparedStatement stmt = null;
        ResultSet rs = null;
        final String sql = "INSERT INTO PICKUP_ORDER (STATUS, CUSTOMER_ID, STORE_ID, ORDER_DATE, PICKUP_DATE, TOTAL_PRICE) VALUES (?, ?, ?, ?, ?, ?)";
